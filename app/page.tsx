      ...
      <section className="w-[62%] h-full bg-[#d5a758] text-stone-900 flex flex-col items-center justify-center relative overflow-y-auto custom-scrollbar p-6">
        ...
        {kioskMode === 'attendance' && (
          <div className="relative z-10 w-full flex flex-row items-center justify-center gap-10">
            ...
            <div className="flex flex-col items-center w-full max-w-sm">
              ...
              {confirmUser ? (
                <div className="bg-[#1f1a16] p-8 rounded-4xl border-4 border-[#e8d5b5] shadow-2xl text-center w-full text-white">
                ...
                <div className="bg-[#1f1a16] p-6 rounded-4xl shadow-2xl space-y-3 w-full border-2 border-stone-800">
                ...
                <div className="bg-[#1f1a16] p-7 rounded-4xl shadow-2xl w-full border-4 border-stone-800">
                  <div className="bg-[#120f0d] border border-stone-700 rounded-2xl h-16 flex items-center justify-center mb-5 shadow-inner">
                    <span className="text-4xl font-mono tracking-[0.4em] text-[#e8d5b5] font-black">{phoneNumber.padEnd(4, '—')}</span>
                  </div>
                  ...
                  <button onClick={handleSearchUser} disabled={isProcessing} className="w-full py-4 bg-[#b88c42] hover:bg-[#a37934] text-stone-950 text-2xl font-black rounded-2xl shadow-[0_5px_0_#755520] active:translate-y-1 transition-all disabled:opacity-50">
            ...
            <div className="flex flex-col gap-5 w-60 shrink-0 pb-10">
               ...
               <button onClick={openMatchWizard} className="w-full bg-[#1f1a16] hover:bg-[#332a24] text-[#e8d5b5] font-extrabold py-6 rounded-3xl shadow-xl text-2xl transition-all border-4 border-stone-800 flex items-center justify-center gap-2">
                 <span>⚔️</span> 대국 신청
               </button>
            </div>
        ...
        {kioskMode === 'profile_detail' && selectedProfile && (
          <div className="relative z-10 w-full max-w-2xl bg-[#1f1a16] text-white p-10 rounded-4xl shadow-2xl border-4 border-[#b88c42] text-center">
            ...
            <button onClick={handleReset} className="w-full py-5 bg-[#b88c42] hover:bg-[#a37934] text-stone-950 text-2xl font-black rounded-2xl shadow-xl transition-all">
              확인 (닫기)
            </button>
          </div>
        )}
                  ...
                  <div className="bg-[#120f0d] p-6 rounded-3xl border-2 border-stone-800 mb-6 flex flex-col gap-5">
                     <div className="flex justify-between items-center px-2">
                        ...
                        <div className="flex items-center gap-3 bg-stone-900 rounded-full p-1.5 border border-stone-700">
                           ...
                           <span className="text-2xl font-black w-20 text-center text-[#dcb36c]">{handicapStones}점</span>
