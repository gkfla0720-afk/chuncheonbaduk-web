        ...
        <div className="bg-[#120f0d] p-8 rounded-3xl mb-8 border border-stone-800 shadow-inner">
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            {profile.current_status === '대국중' && (
              <span className="px-3 py-1 bg-amber-500 text-stone-900 text-sm font-black rounded-lg shadow-md animate-pulse border border-amber-300">
                대국중
              </span>
            )}
          </div>
          ...
          {isLoadingStats ? (
            ...
            <div className="grid grid-cols-2 gap-5">
              <div className="bg-[#241f1b] p-5 rounded-2xl border border-stone-700">
                ...
                <p className="text-stone-400 text-sm font-bold mt-2">승률 {stats.wins + stats.losses > 0 ? Math.round((stats.wins / (stats.wins + stats.losses)) * 100) : 0}%</p>
              </div>
