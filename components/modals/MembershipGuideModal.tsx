    ...
    <div className="modal-backdrop fixed inset-0 z-[60] flex items-center justify-center bg-[rgba(22,16,12,0.56)] p-4 backdrop-blur-[2px]">
      <div className="modal-card w-full max-w-lg rounded-[30px] border border-[#d4c3a2] bg-[#f8f4ee] p-6 shadow-[0_18px_45px_rgba(34,27,20,0.28)]">
        <div className="flex items-start justify-between gap-4">
          ...
          <button onClick={onClose} className="rounded-full bg-stone-200 px-4 py-2 text-sm font-bold text-stone-700 transition hover:bg-stone-300">닫기</button>
        </div>
        ...
        <button onClick={onClose} className="mt-6 w-full rounded-2xl bg-[#2a241d] py-4 text-lg font-bold text-[#f8f3eb] transition hover:bg-[#1f1b18]">
          확인
        </button>
      </div>
    </div>
